...
typedef struct {
	char robotID;
	float OutputPacket[4];//the content of this packet
...
{
	int count=-1;	
	count= UDPSend(broadcast.outputSocket,broadcast.OutputPacket,sizeof(broadcast.OutputPacket),"192.168.1.8",51654);	
